...
from movie_rating_platform.views import index, MovieListView, MovieCreateView, MovieUpdateView, \
    MovieDeleteView, VisitorListView, VisitorDetailView, VisitorCreateView, VisitorUpdateView, VisitorDeleteView, \
    movie_detail_view, create_rating_view, RatingUpdateView, RatingDeleteView, toggle_assign_to_movie
...
urlpatterns = [
    ...
    path("movies/<int:pk>/toggle_wishlist/", toggle_assign_to_movie, name="toggle_wishlist"),
    path("movies/<int:movie_pk>/rating/<int:pk>/update", RatingUpdateView.as_view(), name="rating-update"),
    path("movies/<int:movie_pk>/rating/<int:pk>/delete", RatingDeleteView.as_view(), name="rating-delete"),
    path("movies/<int:pk>/rating/create", create_rating_view, name="rating-create"),
